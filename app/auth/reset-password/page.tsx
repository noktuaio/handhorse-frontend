...
import { handleResetFormSubmit } from "@/shared/application/auth/reset-form-handler";
...
export default function ResetPasswordPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const result = await handleResetFormSubmit({
      email,
      code,
      newPassword,
      confirmNewPassword,
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Informe o código recebido e a nova senha para sua conta.
          </p>
        </div>
